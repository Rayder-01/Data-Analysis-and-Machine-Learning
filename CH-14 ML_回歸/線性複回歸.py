...
#預測腰圍和身高[66,164],[82,172]
new_waist_height = pd.DataFrame(np.array([[66,164],[82,172]]), columns=["Waist", "Height"])
predicted_weight = lm.predict(new_waist_height)
print("預測腰圍和身高[66,164],[82,172] :")
